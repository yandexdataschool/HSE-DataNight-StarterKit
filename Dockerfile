...
RUN wget https://www.dropbox.com/s/06n9g7srz1993kh/evaluation.handout.csv?dl=1 -O evaluation.handout.csv
RUN wget https://www.dropbox.com/s/4y54q61b6s18ofh/train.csv?dl=1 -O train.csv
